...
def print_loss(tracer, patient, df_results, time_window):
    ...
    print('Translation:')
    print('x: ', np.round(np.mean(mse_trans_x), decimals=2),np.round(np.std(mse_trans_x), decimals=2) )
    print('y: ', np.round(np.mean(mse_trans_y), decimals=2),np.round(np.std(mse_trans_y), decimals=2) )
    print('z: ', np.round(np.mean(mse_trans_z), decimals=2),np.round(np.std(mse_trans_z), decimals=2) )
    print()
#     print('Mean square errors between vicra and this network: \n')
    print('Rotation:')
    print('x: ', np.round(np.mean(mse_rot_x), decimals=2),np.round(np.std(mse_rot_x), decimals=2) )
    print('y: ', np.round(np.mean(mse_rot_y), decimals=2),np.round(np.std(mse_rot_y), decimals=2) )
    print('z: ', np.round(np.mean(mse_rot_z), decimals=2),np.round(np.std(mse_rot_z), decimals=2) )
