...
import DL_HMC_attention.mCT.util.python.mCTdata_vicra_toolbox as mCTdata_vicra_toolbox
...
#         df_res_temp['summary_path']=summary_path
        ...
        parameter13_3600 = mCTdata_vicra_toolbox.RotTransMatrix_6Params(df_res_temp.at[0,'vicra parameters'], 2)
        df_res_temp['model parameters'] = df_res_temp['model parameters'].apply(lambda x: mCTdata_vicra_toolbox.DL_HMC_concat_VC_zty(parameter13_3600,x)) 
...
#         df_res_temp['summary_path']=summary_path
        ...
        parameter13_3600 = mCTdata_vicra_toolbox.RotTransMatrix_6Params(df_res_temp.at[0,'vicra parameters'], 2)
        df_res_temp.at[0,'model parameters'] = mCTdata_vicra_toolbox.DL_HMC_concat_VC_zty(parameter13_3600,df_res_temp.at[0,'model parameters 12']) 
        for j in range(1799):
            parameter13_3600=mCTdata_vicra_toolbox.RotTransMatrix_6Params(df_res_temp.at[i,'model parameters'], 2)
            df_res_temp.at[i+1,'model parameters'] = mCTdata_vicra_toolbox.DL_HMC_concat_VC_zty(parameter13_3600,df_res_temp.at[i+1,'model parameters 12']) 
        if 'level_0' in df_res_temp:
            del df_res_temp['level_0']
...
#         df_res_temp['summary_path']=summary_path
        ...
        df_res_temp['model parameters'] = predictions[1800*i:1800*(i+1)]
        df_res_temp['model parameters'] = df_res_temp['model parameters'].apply(lambda x: mCTdata_vicra_toolbox.RotTransMatrix_6Params(x, 2))
        parameter13_3600 = mCTdata_vicra_toolbox.RotTransMatrix_6Params(df_res_temp.at[0,'vicra parameters'], 2)
        df_res_temp['model parameters'] = df_res_temp['model parameters'].apply(lambda x: mCTdata_vicra_toolbox.DL_HMC_concat_VC_zty(parameter13_3600,x)) 
        if 'level_0' in df_res_temp:
            del df_res_temp['level_0']
...
#         df_res_temp['summary_path']=summary_path
        ...
        for jj in range(1800): 
            df_res_temp.at[jj,'model parameters'] = mCTdata_vicra_toolbox.RotTransMatrix_6Params(df_res_temp.at[jj,'model parameters'], 2)
            temp_index = jj // 300
            parameter13_3600 = mCTdata_vicra_toolbox.RotTransMatrix_6Params(df_res_temp.at[temp_index*300,'vicra parameters'], 2)
            df_res_temp.at[jj,'model parameters'] = mCTdata_vicra_toolbox.DL_HMC_concat_VC_zty(parameter13_3600,df_res_temp.at[jj,'model parameters']) 
        if 'level_0' in df_res_temp:
            del df_res_temp['level_0']
